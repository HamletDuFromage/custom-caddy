...
Github workflow building a custom [caddy](https://github.com/caddyserver/caddy) binary. Runs every day and builds+publishes a new binary if caddy received a new update.
